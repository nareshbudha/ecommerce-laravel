  ...
  <main class="pt-90">
    ...
    <section class="shop-checkout container">
        ...
        <div class="checkout-steps">
          ...
          <a href="/address" class="checkout-steps__item">
            <span class="checkout-steps__item-number">01</span>
            <span class="checkout-steps__item-title">
              <span> Addresss</span>
              <em>Manage Permanet Addresss Details Here </em>
            </span>
          </a>
          <a href="/shippingaddress"class="checkout-steps__item active">
            <span class="checkout-steps__item-number">02</span>
            <span class="checkout-steps__item-title">
              <span>Shipping Adress</span>
              <em>Here You Amange Your Shipping Address You Can PIckup Your Orders</em>
            </span>
          </a>
        </div>
        ...
        <ul class="nav nav-tabs mb-5" id="login_register" role="tablist">
          <li class="nav-item" role="presentation">
            <a class="nav-link nav-link_underscore active" id="register-tab" data-bs-toggle="tab"
              href="#tab-item-register" role="tab" aria-controls="tab-item-register" aria-selected="true">Shipping Address Details</a>
          </li>
        </ul>
            ...
            <div class="register-form">
              <form method="POST" action="#" name="register-form" class="needs-validation" novalidate="">
                ...
                <div class="form-floating mb-3">
                  <input id="email" type="email" class="form-control form-control_gray " name="email" value="" required=""
                    autocomplete="email">
                  <label for="email">Localilty*</label>
                </div>
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="address" value="">
                    <label for="address">Road Name, Area, Colony *</label>
                    <span class="text-danger"></span>
                </div>
                <div class="pb-3"></div>
                <div class="form-floating mb-3">
