                        ...
                        <div class="accordion-body px-0 pb-0 pt-3">
                            <ul class="list list-inline mb-0">
                                ...
                                <li class="list-item">
                                    ...
                                    <a href="{{ route('shop.subcategory', [
                        'category' => $activeCategory->slug,
                        'subcategory' => $subcategory->slug
                    ]) }}" class="menu-link py-1"
                                        style="color: {{ request()->route('subcategory') === $subcategory->slug ? 'red' : 'inherit' }}">
                                        {{ $subcategory->name }} ({{ $subcategory->products_count }})
                                    </a>
                                    @else
                                    <span class="menu-link py-1 text-muted">
                                        {{ $subcategory->name }} ({{ $subcategory->products_count }})
                                    </span>
                                    @endif
                                </li>
                    ...
                    <div id="accordion-filter-2" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0">
                            <div class="d-flex flex-wrap">
                                ...
                                {{-- <a href=""
                                    style="background-color: {{ $color }}; width: 20px; height: 20px; display: inline-block; border-radius: 50%; border: 1px solid #ccc; margin-right: 4px;"></a>
                                --}}
                                {{-- @if(isset($activeSubcategory))
                                <a href="{{ route('shop.subcategory', array_merge(request()->route()->parameters(), ['color' => $color])) }}"
                                    style="background-color: {{ $color }}; width: 20px; height: 20px; display: inline-block; border-radius: 50%; border: 1px solid #ccc; margin-right: 4px;">
                                ...
                                @if(isset($activeSubcategory))
                                 <div class="color-item text-center m-1">
                                    <a href="" style="background-color: {{ $color }}; width: 20px; height: 20px; display: inline-block; border-radius: 50%; border: 1px solid #ccc;">
                                    </a>
                                    <div class="color-name" style="font-size: 0.75rem; margin-top: 4px;">
                                        {{ $color }}
                                    </div>
                    ...
                    <div id="accordion-filter-size" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0">
                            <div class="d-flex flex-wrap">
                                ...
                                @if(isset($activeSubcategory))
                                <a href="{{ route('shop.subcategory', array_merge(request()->route()->parameters(), ['size' => $size])) }}"
                                    class="menu-link py-1"
                                    style="color: {{ request()->route('size') === $size ? 'red' : 'inherit' }}">
                                    <span class="swatch-size btn btn-sm btn-outline-light mb-2 me-2">{{ $size }}</span>
                                </a>
                                @else
                                <span class="menu-link py-1 text-muted">
                                    <span class="swatch-size btn btn-sm btn-outline-light mb-2 me-2">{{$size}}</span>
                            ...
                            <ul class="list list-inline mb-0">
                                <div class="accordion-body px-0 pb-0 pt-3">
                                    <ul class="list list-inline mb-0">
                                        ...
                                        <li class="list-item">
                                            @if(isset($activeCategory))
                                            <a href="{{ route('shop.subcategory.brand', [
                        'category' => $activeCategory->slug,
                        'subcategory' => $activeSubcategory?->slug ?? 'all',
                        'brand' => $brand->slug
                    ]) }}" class="menu-link py-1"
                                                style="color: {{ request()->route('brand') === $brand->slug ? 'red' : 'inherit' }}">
                ...
                <div class="accordion-item mb-4">
                    ...
                    <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                        ...
                        <form method="GET" action="">
                            <input class="price-range-slider" type="text" name="price_range" data-slider-min="10"
                                data-slider-max="1000" data-slider-step="5"
                                data-slider-value="[{{ request('min_price', 250) }},{{ request('max_price', 450) }}]"
                                data-currency="Rs" />
