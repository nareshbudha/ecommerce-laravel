    ...
    <section class="shop-main container d-flex pt-4 pt-xl-5">
                    ...
                    <div id="accordion-filter-1" class="border-0">
                        <div class="accordion-body px-0 pb-0 pt-3">
                            <ul class="list list-inline mb-0">
                                ...
                                @endphp
                                <li class="list-item">
                                    <a href="{{ route('shop.featured', $params) }}"
                    ...
                    <div id="accordion-filter-2" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0 pt-3">
                            <ul class="list list-inline mb-0">
                                ...
                                $params = ['subcategory' => $currentfeatured];
                                if (!$isActive) {
                        ...
                        <div class="accordion-body px-0 pb-0">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="color-item text-center m-1">
                                    <a href="{{ url('/shop/featured?' . http_build_query(array_merge(request()->all(), ['color' => $color]))) }}"
                    ...
                    <div id="accordion-filter-size" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0">
                            <div class="d-flex flex-wrap">
                                ...
                                <a href="{{ url('/shop/featured?' . http_build_query(array_merge(request()->all(), ['size' => $size]))) }}"
                ...
                <div class="accordion-item mb-4">
                    ...
                    <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                        ...
                        <div
                            ...
                            <form method="GET" action="{{ route('shop.featured') }}"
        ...
        <div class="shop-list flex-grow-1">
            <div class="d-flex justify-content-between mb-4 pb-md-2">
              ...
              <h2 class="section-title text-center mt-4">Featured Product</h2>
