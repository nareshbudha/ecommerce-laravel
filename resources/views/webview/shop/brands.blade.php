                            ...
                            <div class="accordion-body px-0 pb-0 pt-3">
                                <ul class="list list-inline mb-0">
                                    @foreach ($categories as $category)
                                        ...
                                        @endphp
                                        <li class="list-item">
                                            <a href="{{ route('shop-by-brand', $params) }}"
                                ...
                                <ul class="list list-inline mb-0">
                                    @foreach ($subCategories as $subCategory)
                                        @php
                                            ...
                                            if (request('sub_category') === $subCategory->slug) {
                                                unset($params['sub_category']);
                                            } else {
                                                $params['sub_category'] = $subCategory->slug;
                                            }
                                        @endphp
                                        <li class="list-item">
                                            <a href="{{ route('shop-by-brand', array_merge(['brand' => $currentBrand], $params)) }}"
                                                class="menu-link py-1 {{ request('sub_category') === $subCategory->slug ? 'fw-bold text-red' : '' }}">
                                                {{ $subCategory->name }}
                                            </a>
                                        </li>
                                    @endforeach
                            ...
                            <div class="accordion-body px-0 pb-0">
                                <div class="d-flex flex-wrap">
                                    @foreach ($sizes as $size)
                                        ...
                                        <a href="{{ route('shop-by-brand', array_merge(['brand' => $currentBrand], $params)) }}"
                                            class="swatch-size btn btn-sm mb-3 me-3 {{ request('size') === $size ? 'btn-dark' : 'btn-outline-light' }}">
                                            {{ strtoupper($size) }}
                                        </a>
                                    @endforeach
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <div
                                ...
                                <form method="GET" action="{{ route('shop-by-brand', ['brand' => $brand->slug]) }}"
                                                ...
                                                <div class="swiper-slide" style="object-fit: contain;">
                                                    ...
                                                    @if (!empty($images) && isset($images[0]))
                                                        <a
                                                            ...
                                                            <img loading="lazy"
                                                                src="{{ asset('storage/' . $images[0]) }}" width="330"
