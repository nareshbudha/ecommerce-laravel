...
<main class="pt-90">
                    ...
                    <div class="swiper-container background-img js-swiper-slider"
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_5.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_5-1.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                      </div>
                ...
                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                  <div class="pc__img-wrapper">
                    <div class="swiper-container background-img js-swiper-slider"
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_6.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_6-1.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                      </div>
                      <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
                ...
                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                  <div class="pc__img-wrapper">
                    <div class="swiper-container background-img js-swiper-slider"
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_7.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_7-1.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                      </div>
                      <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
                ...
                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                  <div class="pc__img-wrapper">
                    <div class="swiper-container background-img js-swiper-slider"
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_8.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_8-1.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                      </div>
                      <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
                ...
                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                  <div class="pc__img-wrapper">
                    <div class="swiper-container background-img js-swiper-slider"
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_9.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_9-1.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                      </div>
                      <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
                ...
                <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                  <div class="pc__img-wrapper">
                    <div class="swiper-container background-img js-swiper-slider"
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_10.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                        <div class="swiper-slide">
                          <img loading="lazy" src="images/products/product_10-1.jpg" width="330" height="400"
                            alt="Cropped Faux leather Jacket" class="pc__img">
                        </div>
                      </div>
                      <span class="pc__img-prev"><svg width="7" height="11" viewBox="0 0 7 11"
  ...
  <script>
      document.addEventListener('DOMContentLoaded', function () {
          const menuItems = document.querySelectorAll('.account-nav li');
