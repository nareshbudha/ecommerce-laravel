    ...
    <div class="header-left">
        <a href="index-2.html">
            <img class="" id="logo_header_mobile" alt="" src="/assets/images/logo/logo.png"
                data-light="/assets/images/logo/logo.png" data-dark="/assets/images/logo/logo.png" data-width="154px"
                data-height="52px" data-retina="/assets/images/logo/logo.png">
        </a>
                ...
                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3"
                    ...
                    <span class="header-user wg-user">
                        <span class="image">
                            ...
                            @else
                            <svg class="d-block rounded-circle" width="40" height="40" viewBox="0 0 20 20" fill="none"
                        ...
                        <span class="flex flex-column">
                            <span class="body-title mb-2" style="width: fit-content; margin-right:20px">{{ $user->name
                                }}</span>
                            <span class="text-tiny">{{ $user->Usertype }}</span>
                        </span>
                    </span>
                    @else
                    <span class="header-user wg-user">
                        ...
                        {{-- <span class="flex flex-column">
                            ...
                            <span class="text-tiny">Unknown Role</span>
                        </span> --}}
                    </span>
                    @endif
