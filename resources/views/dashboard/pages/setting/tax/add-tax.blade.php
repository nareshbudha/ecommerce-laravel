                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    ...
                                    <ul class="breadcrumbs flex items-center gap10">
                                        ...
                                        <li><i class="icon-chevron-right"></i></li>
                                        <li>
                                            <div class="text-tiny">New Tax</div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <!-- Form Section -->
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" action="{{ route('tax.store') }}"
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <fieldset>
                                            <div class="body-title">Name *</div>
                                            <input class="flex-grow" type="text" placeholder="Vat Of 2082/83" id="name"
                                        ...
                                        <fieldset>
                                            ...
                                            <input class="flex-grow" type="text" placeholder="50%" id="value"
