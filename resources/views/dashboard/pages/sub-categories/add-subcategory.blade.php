                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <a href="/dashboard/subcategories">
                                ...
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" action="{{ route('sub-categories.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <fieldset class="name">
                                            <div class="body-title">Sub Category Name <span class="tf-color-1">*</span></div>
                                            <input class="flex-grow" type="text" placeholder="Sub Category Name" id="subcategoryname" name="name" required>
                                            @error('name')
