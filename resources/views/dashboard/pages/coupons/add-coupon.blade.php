                                    ...
                                    <form class="form-new-product form-style-1" method="POST" action="{{ route('coupons.store') }}">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            @enderror
                                                                            ...
                                                                            <fieldset class="name">
                                        <div class="body-title">Usage Limit <span class="text-muted">(optional)</span></div>
                                        <input class="flex-grow" type="number" name="usage_limit" placeholder="e.g. 100 uses max"
