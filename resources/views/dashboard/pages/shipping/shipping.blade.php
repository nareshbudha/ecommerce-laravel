                            ...
                            <div class="main-content-wrap">
                                ...
                                <div class="flex items-center justify-between gap-20 mb-27">
                                    ...
                                    <ul class="breadcrumbs flex items-center gap-10">
                                        ...
                                        <li>
                                            <span class="text-tiny">Shipping</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="wg-box">
                                    ...
                                    <div class=" flex items-center justify-between gap-10">
                                        ...
                                        <a href="/dashboard/shipping/create" class="tf-button style-1 w208">
                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $ship->province}}</td>
                                                    <td class="text-center">{{ $ship->district}}</td>
                                                    <td class="text-center">{{ $ship->method}}</td>
                                                    <td class="text-center">{{ $ship->estimated_delivery??'N/A'}}</td>
                                                    <td class="text-center">{{ $ship->notes??'N/A'}}</td>
                                                    <td>
                                                        <div
                                                            class="list-icon-function d-flex justify-content-center gap-4">
                                                            <a href="{{ route('shipping.edit', $ship->id) }}"
                                                                class="item edit">
                                                                <i class="icon-edit-3"></i>
                                                            </a>
                                                            <a href="{{ route('shipping.show', $ship->id) }}"
                                                                class="item eye">
                                                                <i class="icon-eye"></i>
                                                            </a>
                                                            <form action="{{ route('shipping.destroy', $ship->id) }}"
                                                                method="POST"
